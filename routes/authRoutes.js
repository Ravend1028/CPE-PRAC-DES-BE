...
import { signupUser, loginUser, logoutUser, viewUserProfile, editUserProfile, forgotPassword, updateVitals} from '../controllers/authControllers.js';
...
router.put('/updatevitals', updateVitals);
